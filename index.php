...
<body>
    ...
    <div id="valuesModal" class="values-modal">
        <h2>Olá família linda!</h2>
        <p>Este site é mais do que um simples espaço nosso, é um registro da nossa jornada, que esta sendo incrível para mim, saiba que eu te amo muito, e vou continuar te amando cada dia mais! E para nossos filhos que um dia verão isso, saibam: cada momento aqui representa o esforço, o amor e a dedicação que colocamos para construir um futuro melhor para vocês. Seu pai e sua mãe sempre se esforçaram muito, e vão continuar se esforçando, para que vocês tenham uma vida cheia de felicidade. <br><br><h3>PS</h3><p>Respeitem a mamãe! Ela é brava!</p>
        </p>
